...
const StakeYFIG: React.FC<StakeProps> = ({}) => {
  ...
  const tokenBalance = useTokenBalance(contractAddresses.YFIG[56])
      ...
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            ...
            <Label text={`YFiG Tokens Available`}/>
          </StyledCardHeader>
          <StyledCardActions>
            {!allowance.toNumber() ? (
              <Button
